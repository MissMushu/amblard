				...
				<div class="row" id="searchcss ">
					<form role="search">
						<div class="input-field col s2 offset-s10">
							<input id="search" placeholder="Search" type="search" required > <label for="search"><i
		...
		<div id=footer>
			<footer class="page-footer">
					...
					<div class="row">
						<div class="col l6 s12">
							...
							<p class="grey-text text-lighten-4">
								Lycée Professionnel Amblard <br> 43 Rue Amblard, 26000 Valence <br>
								<i class="tiny mdi-maps-local-phone">04.75.82.12.00</i>
							</p>

							<h5 class="white-text">Liens utiles</h5>
							<ul>
								<li><a class="grey-text text-lighten-3" href="#!">Logiciel
										Intranet</a></li>
						...
						<div class="col l6 s12">
							...
							<div class="col l4 offset-l4 s12">
								<iframe
									src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2824.7798169131593!2d4.901198000000004!3d44.92781299999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47f55780d2886fe7%3A0xbfeff8b3d0c37795!2sLyc%C3%A9e+Professionnel+Amblard!5e0!3m2!1sfr!2sfr!4v1434614709892"
									width="350" height="200" frameborder="0" style="border: 0"></iframe>
							</div>
						</div>
					</div>
				</div>
				<div class="footer-copyright">
					<div class="container">
						© 2014 Copyright Morgane Le Calvez - Fakri Tis <a
